...
export function useSEO(profileData) {
  ...
  const updateMetaTags = () => {
    ...
    updateMeta('keywords', 'Victor Djiembou, Portfolio, Full Stack Developer, Data Scientist, AI, IA, ML, Vue.js, Cameroon, SSI, Security, Cameroon, Cameroun, CMR, 237, genious, Engineer, Security, Linux')
